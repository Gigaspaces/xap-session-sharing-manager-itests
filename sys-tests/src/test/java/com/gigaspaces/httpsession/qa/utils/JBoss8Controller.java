...
public class JBoss8Controller extends ServerController {
    ...
    public Runner createStarter() {
        ...
        try {
            ...
            serverConfig = File.createTempFile("jboss8-server" + currentInstance, ".xml", new File(Config.getJboss8Home() + File.separator + "standalone" + File.separator + "configuration"));
